...
import com.richardallenonline.wonders.base.Halikarnassos;
...
public class HalikarnassosTest extends WonderHelper {
    @Test
    public void checkConstructorDefault() throws Exception {
        tst = new Halikarnassos();
